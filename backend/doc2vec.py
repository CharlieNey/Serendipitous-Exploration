...
pretrained_vectors = KeyedVectors.load_word2vec_format("path/to/glove.vec", binary=False)  
...
model.wv.vectors = pretrained_vectors.vectors  # Initialize with pre-trained vectors  
